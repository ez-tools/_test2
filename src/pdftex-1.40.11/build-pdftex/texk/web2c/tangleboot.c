...
#define noptions ( 10 ) 
  ...
  longoptions [currentoption ].val = 0 ;
  currentoption = currentoption + 1 ;
  longoptions [currentoption ].name = "mixedcase" ;
  longoptions [currentoption ].hasarg = 0 ;
  longoptions [currentoption ].flag = 0 ;
  longoptions [currentoption ].val = 0 ;
  currentoption = currentoption + 1 ;
  longoptions [currentoption ].name = "uppercase" ;
  longoptions [currentoption ].hasarg = 0 ;
  longoptions [currentoption ].flag = 0 ;
  longoptions [currentoption ].val = 0 ;
  currentoption = currentoption + 1 ;
  longoptions [currentoption ].name = "lowercase" ;
  longoptions [currentoption ].hasarg = 0 ;
  longoptions [currentoption ].flag = 0 ;
  longoptions [currentoption ].val = 0 ;
  currentoption = currentoption + 1 ;
  longoptions [currentoption ].name = "underlines" ;
  longoptions [currentoption ].hasarg = 0 ;
  longoptions [currentoption ].flag = 0 ;
  longoptions [currentoption ].val = 0 ;
  currentoption = currentoption + 1 ;
  longoptions [currentoption ].name = "strict" ;
  longoptions [currentoption ].hasarg = 0 ;
  longoptions [currentoption ].flag = 0 ;
  longoptions [currentoption ].val = 0 ;
  currentoption = currentoption + 1 ;
  longoptions [currentoption ].name = "loose" ;
  longoptions [currentoption ].hasarg = 0 ;
  longoptions [currentoption ].flag = 0 ;
  longoptions [currentoption ].val = 0 ;
  currentoption = currentoption + 1 ;
  longoptions [currentoption ].name = "length" ;
  ...
  do {
    ...
    else if ( ( strcmp ( longoptions [optionindex ].name , "mixedcase" ) == 
    0 ) ) 
    {
      forceuppercase = false ;
      forcelowercase = false ;
    } 
    else if ( ( strcmp ( longoptions [optionindex ].name , "uppercase" ) == 
    0 ) ) 
    {
      forceuppercase = true ;
      forcelowercase = false ;
    } 
    else if ( ( strcmp ( longoptions [optionindex ].name , "lowercase" ) == 
    0 ) ) 
    {
      forceuppercase = false ;
      forcelowercase = true ;
    } 
    else if ( ( strcmp ( longoptions [optionindex ].name , "underlines" ) == 
    0 ) ) 
    {
      allowunderlines = true ;
    } 
    else if ( ( strcmp ( longoptions [optionindex ].name , "strict" ) == 0 ) 
    ) 
    {
      strictmode = true ;
    } 
    else if ( ( strcmp ( longoptions [optionindex ].name , "loose" ) == 0 ) 
    ) 
    {
      strictmode = false ;
    } 
    else if ( ( strcmp ( longoptions [optionindex ].name , "length" ) == 0 ) 
    ) 
    {
      len = atoi ( optarg ) ;
      if ( ( len <= 0 ) || ( len > maxidlength ) ) 
      len = maxidlength ;
      unambiglength = len ;
    } 
...
initialize ( void ) 
{
  ...
  {register integer for_end; zi = 0 ;for_end = 4 ; if ( zi <= for_end) do 
    {
      tokstart [zi ]= 0 ;
      tokptr [zi ]= 0 ;
    } 
...
zidlookup ( eightbits t ) 
{
  ...
  if ( ( p == nameptr ) || ( t != 0 ) ) 
  {
	...
	if ( ( buffer [i ]!= 95 ) || ( allowunderlines && ! strictmode ) ) 
	{
	  if ( ( strictmode || forceuppercase ) && ( buffer [i ]>= 97 ) ) 
	  choppedid [s ]= buffer [i ]- 32 ;
	  else if ( ( ! strictmode && forcelowercase ) && ( buffer [i ]>= 65 
	  ) && ( buffer [i ]<= 90 ) ) 
	  choppedid [s ]= buffer [i ]+ 32 ;
	...
	while ( q != 0 ) {
	    
	  {
	    ...
	    while ( ( k < bytestart [q + 3 ]) && ( s < unambiglength ) ) {
	      ...
	      c = bytemem [w ][ k ];
	      if ( c != 95 || ( allowunderlines && ! strictmode ) ) 
	      {
		if ( ( strictmode || forceuppercase ) && ( c >= 97 ) ) 
		c = c - 32 ;
		else if ( ( ! strictmode && forcelowercase ) && ( c >= 65 ) && 
		( c <= 90 ) ) 
		c = c + 32 ;
		if ( choppedid [s ]!= c ) 
		goto lab32 ;
...
{
  /* 31 */ register namepointer Result; unsigned char c  ;
  integer j  ;
  integer k  ;
  unsigned char w  ;
  namepointer p  ;
...
{
  register namepointer Result; unsigned char c  ;
  integer count  ;
  integer j  ;
  integer k  ;
  unsigned char w  ;
...
zpushlevel ( namepointer p ) 
{
  if ( stackptr == stacksize ) 
  {
    ...
    zo = curstate .replfield % 5 ;
    curstate .bytefield = tokstart [curstate .replfield ];
    curstate .endfield = tokstart [curstate .replfield + 5 ];
    curstate .modfield = 0 ;
  } 
} 
void 
poplevel ( void ) 
{
  ...
  {
    if ( ( ilk [curstate .namefield ]== 3 ) || ( ilk [curstate .namefield ]
    == 4 ) ) 
    {
      nameptr = nameptr - 1 ;
      textptr = textptr - 1 ;
...
getoutput ( void ) 
{
  ...
  if ( a < 10240 ) 
  {
	...
	0 ) ) poplevel () ;
	if ( ( stackptr == 0 ) || ( ( ilk [a ]== 3 ) && ( tokmem [zo ][ 
	curstate .bytefield ]!= 40 ) ) || ( ( ilk [a ]== 4 ) && ( tokmem [
	zo ][ curstate .bytefield ]!= 91 ) ) ) 
	{
	  {
	    putc ('\n',  stdout );
...
zsendval ( integer v ) 
{
  ...
  {case 1 : 
	...
	if ( ( ( outbuf [outptr - 3 ]== 68 ) && ( outbuf [outptr - 2 ]== 
	73 ) && ( outbuf [outptr - 1 ]== 86 ) ) || ( ( outbuf [outptr - 3 ]
	== 100 ) && ( outbuf [outptr - 2 ]== 105 ) && ( outbuf [outptr - 1 
	]== 118 ) ) || ( ( outbuf [outptr - 3 ]== 77 ) && ( outbuf [outptr 
	- 2 ]== 79 ) && ( outbuf [outptr - 1 ]== 68 ) ) || ( ( outbuf [
	outptr - 3 ]== 109 ) && ( outbuf [outptr - 2 ]== 111 ) && ( outbuf 
	[outptr - 1 ]== 100 ) ) ) 
	goto lab666 ;
      } 
      outsign = 32 ;
...
sendtheoutput ( void ) 
{
  ...
  while ( stackptr > 0 ) {
	...
	while ( ( k < maxidlength ) && ( j < bytestart [curval + 3 ]) ) {
	  ...
	  j = j + 1 ;
	  if ( forceuppercase && ( outcontrib [k ]>= 97 ) ) 
	  outcontrib [k ]= outcontrib [k ]- 32 ;
	  else if ( forcelowercase && ( outcontrib [k ]<= 90 ) ) 
	  outcontrib [k ]= outcontrib [k ]+ 32 ;
	  else if ( ! allowunderlines && ( outcontrib [k ]== 95 ) ) 
	  k = k - 1 ;
	} 
	sendout ( 2 , k ) ;
      } 
	...
	n = 10 ;
	while ( curval >= n ) n = 10 * n ;
	do {
	    n = n / 10 ;
	  outcontrib [k ]= 48 + ( curval / n ) ;
	  curval = curval % n ;
	  k = k + 1 ;
	} while ( ! ( n == 1 ) ) ;
	if ( outcontrib [2 ]!= 58 ) 
...
zscannumeric ( namepointer p ) 
{
  ...
  while ( true ) {
	...
	{
	  accumulator = accumulator + nextsign * intcast ( val ) ;
	  nextsign = 1 ;
	} 
	goto lab21 ;
      } 
	...
	{
	  accumulator = accumulator + nextsign * intcast ( equiv [q ]- 
	  1073741824L ) ;
	  nextsign = 1 ;
	} 
      } 
...
void mainbody( void ) {
  ...
  buffer [0 ]= 32 ;
  inputhasended = false ;
  Fputs ( stdout ,  "This is TANGLE, Version 4.5" ) ;
  fprintf ( stdout , "%s\n",  versionstring ) ;
  phaseone = true ;
  modulecount = 0 ;
  do {
