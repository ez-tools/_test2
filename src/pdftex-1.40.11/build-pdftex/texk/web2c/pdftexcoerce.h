...
void removeendM (void);
#define removeendM_regmem register memoryword *mem=zmem;
void insertendM (void);
#define insertendM_regmem register memoryword *mem=zmem;
...
#define checkpdfminorversion_regmem register memoryword *eqtb=zeqtb;
...
/* Some definitions that get appended to the `coerce.h' file that web2c
   outputs.  */
/* $Id: coerce.h 17953 2010-04-21 10:54:29Z peter $ */
